...
# module load tabix/0.2.6 ; conda activate py36 ; export PYTHONPATH=/home/rparrish/.conda/envs/py36/lib/python3.6/site-packages/ ; ipython
...
args.SR_TWAS_dir = '/mnt/YangFSS/data2/rparrish/SR_TWAS/sim/scripts/TIGAR_SR_sim'
args.chrm = '19'
args.cvR2 = 1
args.cvR2_threshold = 0.005
args.data_format = 'DS'
args.geneexp_path = '/mnt/YangFSS/data2/rparrish/SR_TWAS/sim/expression/raw_dosage/ROSMAP_expr_zeros.txt'
args.geno_path = '/mnt/YangFSS/data2/rparrish/SR_TWAS/sim/genotype/ROSMAP_ABCA7_raw.dosage.gz'
...
args.log_file = 'SR_Naive_train_log_scrap.txt'
args.out_prefix = 'CHR19_SR_train'
args.out_info_file = 'SR_train_info_scrap.txt'
args.out_weight_file = 'SR_train_weight_scrap'
args.out_naive_prefix = 'CHR19_Naive_train'
args.out_naive_info_file = 'Naive_train_info_scrap.txt'
args.out_naive_weight_file = 'Naive_train_weight_scrap'
args.sub_dir = 0
args.thread = 16
args.sampleid_path = '/mnt/YangFSS/data2/rparrish/SR_TWAS/sim/sampleid/ROSMAP_valid_400_sampleid.txt'
args.weight_threshold = 0
args.w_paths = ['/mnt/YangFSS/data2/rparrish/SR_TWAS/sim/train//sims/GTEx_train_weight_zeros', '/mnt/YangFSS/data2/rparrish/SR_TWAS/sim/train//sims/ROSMAP_train_weight_zeros']
args.window = 1000000
...
if not args.log_file:
	args.log_file = args.out_naive_prefix + '_log.txt'
...
for k in tabix_target_ks:
	...
	W_k = tg.read_tabix(start, end, target=target, raise_error=False, do_zgrep=True, **weights_info[k])
