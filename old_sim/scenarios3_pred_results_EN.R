...
######################################################
# ## causal_prop GTEx_He2 ROSMAP_He2
# jobs <- c('0.001_0.001_1_0.1_0.1', '0.001_0.001_1_0.2_0.2', '0.001_0.001_1_0.5_0.5', 
# '0.01_0.01_1_0.1_0.1', '0.01_0.01_1_0.2_0.2', '0.01_0.01_1_0.5_0.5', 
# '0.05_0.05_1_0.1_0.1', '0.05_0.05_1_0.2_0.2', '0.05_0.05_1_0.5_0.5', 
# '0.1_0.1_1_0.1_0.1', '0.1_0.1_1_0.2_0.2', '0.1_0.1_1_0.5_0.5', 
# '0.001_0.001_1_0.1_0.05', '0.001_0.001_1_0.2_0.1', '0.001_0.001_1_0.5_0.25', 
# '0.01_0.01_1_0.1_0.05', '0.01_0.01_1_0.2_0.1', '0.01_0.01_1_0.5_0.25', 
# '0.05_0.05_1_0.1_0.05', '0.05_0.05_1_0.2_0.1', '0.05_0.05_1_0.5_0.25', 
# '0.1_0.1_1_0.1_0.05', '0.1_0.1_1_0.2_0.1')
...
# # jobs <- c('0.1_0.25_0.5')
# jobs <- c('0.1_0.1_1_0.5_0.25')


# suffixes <- c('_EN_120621','_EN_121721')
# jobs <- c( '0.1_0.1_0.5_0.5_0.5', '0.1_0.1_0.5_0.2_0.2')
suffixes <- c('_EN_overlap')
jobs <- c('0.001_0.001_0.5_0.1_0.1', '0.001_0.001_0.5_0.2_0.2', '0.001_0.001_0.5_0.5_0.5', 
...
# suffix <- '3'
suffix <- 'overlap'
all_out_pred_path <- paste0(dir, 'power/', 'all_pred_results_EN', suffix, '.txt')
all_out_power_path <- paste0(dir, 'power/', 'all_power_results_EN', suffix, '.txt')
...
load(paste0(dir, 'power/data/expr_var', 'EN_overlap','.Rdata'))
...
for (job in jobs) {
	print(job)
	old_job <- oldjobstr(job)

	# get start time
	start_time <- Sys.time()

	# load job data
	load(paste0(dir, 'power/data/sim_data_', job, '_EN.Rdata'))
	...
	# 	do.call(rbind, strsplit(sim_data$TargetID, '_'))[,4])))
	...
	save(out_data, out_power, file=paste0(dir, 'power/data/out_power_pred_', job, '_EN.Rdata'))
